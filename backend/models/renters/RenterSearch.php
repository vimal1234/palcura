...
use backend\models\renters\Renters;
use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;

/**
* RenterSearch represents the model behind the search form about User.
*/
class RenterSearch extends Model {
    ...
    public function search($params) {
		//$query = Renters::find()->where('user_type = :user_type AND delete_status = :delete_status',[':user_type' => RENTER,':delete_status' => '0']);
$query = Renters::find()->where("(user_type = '".RENTER."' OR user_type = '".BORROWER_SITTER."' OR user_type = '".OWNER_BORROWER."' OR user_type = '".ALL_PROFILES."') ");
