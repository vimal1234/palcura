...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = 'http://' . $_SERVER['HTTP_HOST'] . '/projects/iwear/development/cms/images'; // Relative to domain name
	$config['upload_path'] = $rootpath . '/images'; // Physical path. [Usually works fine like this]
