...
if(isset($_GET['subfolder']) && !empty($_GET['subfolder'])) {
    ...
    $imgUrl = $imgPath. $subfolder . '/' . $subdir;
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
		...
		<input type="hidden" id="img_path" value="<?php echo $imgUrl; ?>" />
			...
			<div class="filters">
				...
				<div class="span8 pull-right">
				    ...
				    <div class="pull-right"><?php echo lang_Filter; ?> : 
								<input id="select-type-6" name="radio-sort" type="radio" data-item="ff-item-type-6" class="hide"  />
								 <label id="ff-item-type-6" for="select-type-6" class="btn  ff-label-type-6"><?php echo lang_doc; ?></label>
	...
	<div class="span12">
		...
		foreach ($files as $file) {  
			...
			if ($file != '.' && $file != '..' && !is_dir($root . $cur_dir . $file)) {
				...
				$class_ext = 3;
			    }else if(in_array($file_ext, $ext_doc)){
				$class_ext = 6;
				}else{
				$class_ext = 1;
			    }
...
?>
	...
	?>
	<li class="ff-item-type-6 fullwidth" style="display:none;">
		<div id="Instruction">
		    <h5>To Embed Image</h5>
				<p class="point">1.</p>
				<p> Select <strong>Insert / edit image </strong> option left to file manger option.</p>
				<p class="point">2.</p>
				<p> Use the source icon to browse the file manger or upload new from system.</p>
				<p class="point">3.</p>
				<p> Use ok to add image in editor</p>
			<h5>To Embed Video</h5>
				<p class="point">1.</p>
				<p> Select <strong>Insert / edit video </strong> option right to file manger option.</p>
				<p class="point">2.</p>
				<p> Place the Iframe share code from youtube/ Vimeo in the <strong> Embed </strong>tab and press ok.</p>
				<p class="point">3.</p>
				<p> You can also upload the video using the source icon on the right side of souce field under <strong> General</strong> Tab.</p>
			<h5>To Embed Link</h5>
				<p class="point">1.</p>
				<p> Select <strong>Insert Link / file </strong> option next to undo redo option.</p>
				<p class="point">2.</p>
				<p> Use the source icon to browse the file manger and link required file</p>
				<p class="point">3.</p>
				<p> Use ok to add link in editor</p>
	</li>
	</div><?php
		closedir($dir);
		?>
