...
$this->params['breadcrumbs'][] = ['label' => 'Sitters', 'url' => ['index']];
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Sitter: <?php echo $this->title; ?></h3>
            </div>
        </div>
...
/*[
           ...
           'label' => 'Images',
            'value' => function ($model) {
                return Html::img($uploadPath . $model['user_images'],
                    ['width' => '60px']);
            },
        ],*/

								[
									'attribute' => 'user_docuemnts',
									'label' => 'Documents',
									'format' => 'raw',
								],								
                                [
