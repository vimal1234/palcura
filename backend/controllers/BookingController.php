...
use backend\models\booking\BookingSearch;
...
class BookingController extends Controller {
	...
	*/
    public function actionIndex() {
		$searchModel  = Yii::createObject(BookingSearch::className());
    ...
    */
    public function actionDelete($id) {
		$this->findModel($id)->delete();
		 Yii::$app->session->setFlash('item', 'Selected Booking deleted successully!');
    ...
    public function actionStatus($id) {
         ...
         if(isset($postArr) && !empty($postArr)) {
            if (Yii::$app->request->isAjax){
                ...
                if($model->save()) {
                    Yii::$app->session->setFlash('item' ,'Booking status has been changed successfully.');
                } else {
