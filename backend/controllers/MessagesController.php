...
class MessagesController extends Controller {
    ...
    */
    public function actionDelete($id) {
		$this->findModel($id)->delete();
		 Yii::$app->session->setFlash('item', 'Selected message deleted successully!');
    ...
    */
    public function actionStatus($id) {
		...
		$m = Yii::$app->db->createCommand()->update('messages', ['status' => $postArr['status']], 'id = '.$id)->execute();
                if($m) {
                    Yii::$app->session->setFlash('item' ,'Message status has been changed successfully.');
                } else {
