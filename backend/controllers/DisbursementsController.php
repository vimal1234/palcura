...
use backend\models\disbursement\DisbursementSearch;
...
class DisbursementsController extends Controller {
	...
	*/
	public function actionIndex() {
		$searchModel  = Yii::createObject(DisbursementSearch::className());
	...
	public function actionStatus($id) {
		 ...
		 if(isset($postArr) && !empty($postArr)) {
			if (Yii::$app->request->isAjax){
				...
				if($model->save()) {
					Yii::$app->session->setFlash('item' ,'Booking amount has been transfered successfully.');
				} else {
