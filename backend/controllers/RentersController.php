...
use backend\models\renters\AddRenter;
use backend\models\renters\RenterSearch;
use backend\models\renters\UpdateRenter;
...
class RentersController extends Controller {
	...
	*/
    ...
    public function actionIndex() {
        $searchModel = Yii::createObject(RenterSearch::className());
	...
	*/
    ...
    public function actionCreate() {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            $userDetail = Yii::$app->request->post('AddRenter');
	...
	*/
    protected function findModel($id) {
        if (($model = Renters::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function actionUserverification($id) {
         ...
         if(isset($postArr) && !empty($postArr)) {
            if (Yii::$app->request->isAjax){
                ...
                if($model->save()) {
                    Yii::$app->session->setFlash('item' ,'Renter(s) profile has been '.$st.' successfully.');
                } else {
                    Yii::$app->session->setFlash('item', 'No status is set for selected images, please try again.');
                }
                die();
