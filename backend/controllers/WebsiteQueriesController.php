...
use backend\models\websitequeries\WebsiteQueriesSearch;
...
*/
class WebsiteQueriesController extends Controller {
	/**
	* @inheritdoc
	*/
	...
	*/
    public function actionIndex() {
		$searchModel  = Yii::createObject(WebsiteQueriesSearch::className());
    ...
    */
    public function actionDelete($id) {
		$this->findModel($id)->delete();
		 Yii::$app->session->setFlash('item', 'Selected query deleted successully!');
    ...
    */
    protected function findModel($id) {
        if (($model = WebsiteQueries::findOne($id)) !== null) {
            return $model;
        } else {
