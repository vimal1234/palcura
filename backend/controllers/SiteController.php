...
class SittersController extends Controller {
	...
	*/
    ...
    public function verifiedAccountEmail($user) {
		...
		$subject  = "Welcome to Palcura to “Congratulations! You are officially a verified PalCura Pet
Sitter!";
		$message  = '';
		$message .='<tr>';
		...
		$message .='</tr>';
		$message .='<tr>';
			$message .='<td style="font-size:13px; color:#656565; line-height:18px; padding-bottom:10px;">We are stoked to have you as a part of PalCura! We will notify you once you get a booking request or message.
			Until then, feel free to check out the <a href="https://www.palcura.com/payments">exciting rewards</a> we have in store for you and some great <a href="http://blog.palcura.com" target="_blank">blog articles!</a>”
			</td>';
		$message .='</tr>';
		$message .='<tr>';
			$message .='<td height="5"></td>';
					...
					if($st == 'verified') {
						#Hit Mailchimp Api code
							...
							$json = json_encode([
								...
								'ADDRESS'=> array('addr1'=>"$add1",'city'=>'NULL', 'state'=>'NULL', 'zip'=>'NULL'),
								'PHONE'=> $model->phone
								],
