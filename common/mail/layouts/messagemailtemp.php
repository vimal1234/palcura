                ...
                <td bgcolor="#ffffff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td valign="top" bgcolor="#fcfcfc" style="padding:12px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <?= $content ?>
                          <tr><td><p style="color:#8c8c8c; font-size:13px;line-height:19px; margin:0 0 12px 0; font-style:italic;">Your friends at PalCura<br/>Share the care…Multiply the love! <img style="width:18px;" src="<?php echo WEBSITE_IMAGES_PATH ?>foot-pic.jpg" border="0" alt="" /></p>
							  </td>
                          </tr>
