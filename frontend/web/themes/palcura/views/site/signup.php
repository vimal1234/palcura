...
.captcha {width:230px;overflow:auto;
}
}*/
</style>
...
<section class="contentArea">
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="formContent registerForm"> <img class="contact-bg" src="<?= $siteimage ?>/contact-bg.png" alt="">
          <div class="col-md-12 col-sm-12 col-xs-12 removePad">
            ...
            <div class="alert alert-grey alert-dismissible" id="scrrollhere">
              ...
              <i class="fa fa-check"></i> <?php echo Yii::$app->session->getFlash('item'); ?> </div>
            <?php endif; ?>
            <?php
            ...
            <div class="row-block">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <?php
									...
									'class' => "form-control",
									]])->passwordInput(['maxlength' => 100])->label('Create a Password <span class="required"></span>');
								?>
              </div>
            </div>
            <div class="row-block" style="display:none;">
              <div class="col-md-6 col-sm-6 col-xs-12"> <?php echo $form->field($model, 'interested_in_renting')->hiddenInput(['value'=> 0])->label(false); ?> </div>
            </div>
            <div class="row-block">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <?php
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group signUpOuter">
                  <div class="col-lg-7  col-sm-6 col-xs-6 col-md-4 signUpListing ageListing"> <strong>Are you 18 years or older?</strong>
                    <input class="user_dob" name="dob" 
										value="1" type="radio" <?php echo $dobselected;?>>
                    Yes
                    <input class="user_dob" name="dob" 
										value="0" type="radio" <?php echo $dobnoselected; ?>>
                    No
            ...
            <div class="row-block pet_t_ow">
              <div class="col-md-12 col-sm-6 col-xs-12">
                <div class="form-group signUpOuter accterms">
                  <div class="col-lg-12  col-sm-12 col-xs-12 col-md-4 signUpListing"> <strong>Interested in joining our pet borrowing program? Share the care of your pet and help future pet owners gain confidence</strong>
                    <input class="renting_pet" name="pertrenting" 
										value="1" type="radio" <?php echo $yesselected;?>>
                    Yes
                    <input class="renting_pet" name="pertrenting" 
										value="0" type="radio" <?php echo $noselected; ?>>
                    No
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="captcha"> <?php echo $form->field($model, 'reCaptcha')->widget(\yii\recaptcha\ReCaptcha::className(),['siteKey' => SITE_KEY])->label(false); ?>
	...
	<div class="container">
              <div class="row"> <img src="<?php echo $siteimage; ?>/animal-img.jpg" alt="animal image" title="Palcura"> </div>
            </div>
</section>
<?php
	$modelID = "adduserform";
