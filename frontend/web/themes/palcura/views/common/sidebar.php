...
<div class="col-md-2 col-sm-3 col-xs-12">
	...
	<div class="ratting-star" style="width:100%;"></div>
		<div class="sideThumb">
		...
		<div class="verifiedMain">
			...
			<?php }elseif($attributes['verification_badge'] == 0  && $logged_user== SITTER){ 
						 ...
						 if (isset($attributes['profile_completed']) AND $attributes['profile_completed']==1){
							 ?>
							 ...
							 ?>
							<div class="verified"><i class="fa fa-check-circle" aria-hidden="true"></i>Not Complete</div>
						<?php	 
						 }
						?>
