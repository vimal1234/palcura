                    ...
                    <div class="form-group">
                        ...
                        <div class="select-contact">
                            <select id="pet_weight" class="form-control searchfilter01" name="Search[pet_weight]">
                                ...
                                <option value="1" <?php if (isset($getsercharray['pet_weight']) && $getsercharray['pet_weight'] == "1") {
                                    echo "selected";
                                } else {
                                    echo '';
                                } ?>>0-15lbs</option>
                                <option value="" disabled><strong>Medium</strong></option>
                                <option value="2" <?php if (isset($getsercharray['pet_weight']) && $getsercharray['pet_weight'] == "2") {
                                    echo "selected";
                                } else {
                                    echo '';
                                } ?>>16-40lbs</option>
                                <option value="" disabled><strong>Large</strong></option>
                                <option value="3" <?php if (isset($getsercharray['pet_weight']) && $getsercharray['pet_weight'] == "3") {
                                    echo "selected";
                                } else {
                                    echo '';
                                } ?>>41-100lbs</option>
                                <option value="" disabled><strong>Giant</strong></option>
                                <option value="4" <?php if (isset($getsercharray['pet_weight']) && $getsercharray['pet_weight'] == "4") {
                            echo "selected";
                        } else {
                            echo '';
                        } ?>>101+lbs</option>
