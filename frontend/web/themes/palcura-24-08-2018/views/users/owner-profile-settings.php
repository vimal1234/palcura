						...
						<div class="row-block">
							<div class="col-md-4 col-sm-6 col-xs-12">
								<?php
									...
									'class' => "form-control whiteBorder petparentn".$k."",								
									]])->dropDownList($pet_type,['options'=>[$pet_parent_type=>["Selected"=>true]]])->label('Pet Type <span class="required">*</span>');
								?>				  
							</div> 
							<div class="col-md-4 col-sm-6 col-xs-12" id="pettype<?php echo $k;?>">
								<?php						
									echo $form->field($model, 'pet_type['.$k.']', ['inputOptions' => [
									'class' => "form-control whiteBorder petbreedtypen".$k."",
