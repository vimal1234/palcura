...
$serviceproviderdata 	= Yii::$app->commonmethod->getServiceproviderdata($userid);
	...
	$pitch  = $posteditdata['UpdateSitter']['pitch'];
	}
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="row-block">
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								...
								'class' => "form-control whiteBorder",
								]])->textInput(['maxlength'=>255 , "placeholder" => "Eg: We only take one Pet at a time",'autofocus' => true,'value'=> $pitch])->label('Your Pitch <span>*</span>');
								?>   	                
							</div>
						</div>
...
<div class="col-md-12 col-sm-6 col-xs-12">
								<?php
									...
									'class' => "form-control",
									]])->textInput(['maxlength'=>150 , 'autofocus' => true])->label('PayPal Email <span> * </span><br><strong class="reduceSize">(Payment will be made to your paypal account after completion of service)</strong>');
								?>   
							</div>
						</div>		
						...
						<div class="row-block">
							...
							<!--input id="uploadFile" placeholder="Add files from My Computer"/-->
								...
								<?php
									...
									'class' => "form-control imageBrowser",
									]])->fileInput(['multiple' => true,"accept"=>"image/*"])->label('House Images<span> * </span><br><strong class="reduceSize">(Minimum two inside house pictures. Rest assured these pictures will not be displayed to the owners)</strong>');
								?>
								<!--/div-->	
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								...
								'class' => "form-control imageBrowser",
								]])->fileInput(['multiple' => true])->label('Upload Your ID<span> * </span>');
								?>
							</div>
							
						</div>
																							
					<?php if(!empty($userServices) && count($userServices)>0 && empty($posteditdata)){ 
					$chkminservice = 0;
					...
					setpetweight(weight,key);
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<?php
										...
										'class' => "form-control whiteBorder",
										]])->textInput(['maxlength'=>15 ,'type' => 'number', 'min' => 1, 'autofocus' => true,'value' => $val['price']])->label('Price <span>*</span>');
									?>
								</div>		
							...
							<div class="col-md-6 col-sm-6 col-xs-12 selectsearchoptions weightclass">								
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<?php
										...
										'class' => "form-control whiteBorder",
										]])->textInput(['maxlength'=>15 ,'type' => 'number', 'min' => 1, 'autofocus' => true])->label('Price <span>*</span>');
									?>
								</div>								
								<!--div class="col-md-4 col-sm-6 col-xs-12">
