...
?>  <div class="row">
        <div class="col-xs-12">
            <div class="home-banner become-sitter-banner">
					<h3>Do you <img src="<?php echo $siteimage; ?>/hard-icon.png" alt="animal image" title="Set Your own Schedule"> Pets?</h3>
...
<img src="<?php echo $siteimage; ?>/why-we-come.png" alt="icon" title="vedio">
			</div>
