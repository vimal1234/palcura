...
define("SITE_URL1", "http://192.168.1.250:8083/Palcura/");
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px; display:none;" id="showloader">
         <div  id="loader"  align="center" style="display:none;">        
		    <img class="img-responsive" src="<?php echo SITE_URL1; ?>common/uploads/loader/giphy.gif" alt="" width="70px" height="70px">
		    </div>
...
$.ajax({ 
		...
		window.location.href = '<?php echo SITE_URL1 ?>'+'bookings/index'; 
			//if(response)	
