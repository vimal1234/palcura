            ...
            <div class="formBorder">
                <div class="form-group">
                 ...
                 <select class="form-control" name="Search[sort_by]" id="sort_by" onchange="searchWithSorting();">
                    <option value="1" <?php if($sort_by == 1) { echo"selected"; } ?>>low to high rating</option>
                    <option value="2" <?php if($sort_by == 2) { echo"selected"; } ?>>high to low rating</option>
                    <option value="3" <?php if($sort_by == 3) { echo"selected"; } ?>>low to high price</option>
                    <option value="4" <?php if($sort_by == 4) { echo"selected"; } ?>>high to low price</option>
                  </select>
                </div>
            </div>
          </div>
	   ...
	   <?php
		   ...
		   if(!empty($searchResult) && count($searchResult) > 0) {
			...
			foreach($searchResult as $key=>$val) {
			  ...
			  $day_price 		= (isset($val['per_day_price']) ? $val['per_day_price'] : 0);
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="rightPopup">
                            ...
                            <div class="reviewDetailsToggle">
                              <?php echo starRating($val['rating']); ?>
                              <span><?php echo $val['t_rating']/5; ?> Reviews</span> </div>
...
<!--
                              <div>”<?php //echo (isset($val['pitch']) ? $val['pitch'] : '--'); ?>”</div>
-->
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="sliderPopup">
                            <div class="carousel slide multi-item-carousel" id="theCarousel">
                              <div class="carousel-inner">
								<?php
								$user_images			= Yii::$app->commonmethod->getUserActiveDocuments($val['id'],USER_IMAGES);
                              ...
                              <a class="left carousel-control" href="#theCarousel" data-slide="prev"><img src="<?= WEBSITE_IMAGES_PATH.'toggle-arrow-left.png' ?>"></a> <a class="right carousel-control" href="#theCarousel" data-slide="next"><img src="<?= WEBSITE_IMAGES_PATH.'toggle-arrow-right.png' ?>"></a> </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          ...
                          ?>
								<div class="greyBoxPopup">
									<div class="greyThumb2"> <img class="img-responsive" src="<?php echo $reviewerprofileimage; ?>" alt="" height="107px;" width="114px;"> </div>
									<div class="greyText">
										<div class="ratingBar">
											<div class="pull-left">
            ...
            <div class="orangeBtn"> <a href="<?= Url::home().'users/testview/'.$val['id'] ?>">View details</a> </div>
          </div>
...
<!--search listing end-->
        <?php } 
			...
			echo '<p>There are currently no lenders available that match your criteria.</p>';
		} ?>
