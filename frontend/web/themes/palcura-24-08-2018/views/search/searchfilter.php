...
$getsercharray = $session->get('searchrequestdata'); //echo "<pre>"; print_r($getsercharray); die;
            ...
            <div class="customForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="select-contact">
                            <select id="pet_weight" class="form-control searchfilter01" name="Search[pet_weight]">
								...
								if(isset($getsercharray['pet_weight']) AND $getsercharray['pet_weight'] == "1") {
									echo "selected";
                                } else {
									echo '';
                                } ?>>0-15lbs</option>
                                ...
                                <option value="2" <?php
							if(isset($getsercharray['pet_weight']) AND $getsercharray['pet_weight'] == "2") {
                                    echo "selected";
                                } else {
                                    echo '';
                                } ?>>16-40lbs</option>
							...
							if(isset($getsercharray['pet_weight']) AND $getsercharray['pet_weight'] == "3") {
                                    echo "selected";
                                } else {
                                    echo '';
                                } ?>>41-100lbs</option>
                                <option value="" disabled><strong>Giant</strong></option>
                                <option value="4" <?php if (isset($getsercharray['pet_weight']) AND $getsercharray['pet_weight'] == "4") {
                            echo "selected";
                        } else {
                            echo '';
                        } ?>>101+lbs</option>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="form-group">
                                ...
                                echo $form->field($model, 'zip', ['inputOptions' => [
...
if(isset($getsercharray['selected_pal']) && $getsercharray['selected_pal'])
{	
	for ($i = 1; $i <= 20; $i++) {
		$npsl = '';
		
		if ($getsercharray['selected_pal'] == $i) {
			$npsl = "selected";
		}
...
<script>
    $(function () {
        ...
        $("#no_of_pals").change(function () {
            var val = $(this).val();
            $("#_no_of_pals_in_popup").val(val);
        });
    });
