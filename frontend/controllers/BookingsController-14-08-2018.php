                          ...
                          <tr>
                            <td align="left">
								<ul style="background-color: #fff3e3; color:#000000; font-size:15px; list-style:none; margin:0; padding:0; font-weight:600; padding: 10px 20px; letter-spacing: 0.3px;">
									...
									<li>Seach for petsitter: <span style="font-weight:400; line-height:30px;"><a href=https://www.palcura.com/search/petsitter</span></li>	
									<li>Terms and Conditions: <span style="font-weight:400; line-height:30px;"><a href=https://www.palcura.com/Terms-and-Conditions</span></li>	
								</ul>
							</td>
                          </tr>
                          <tr>
...
//                die;
                ...
                //$this->redirect(['bookings/requestbooking']);
...
//                echo  $model->amount; die;
                ...
                if (!isset($model->id)) {
                    ...
                    Yii::$app->session->setFlash('item', 'Your pet care request has been sent for confirmation.');
