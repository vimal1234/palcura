    ...
    public function behaviors() {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['index','update','myprofile','settings','dashboard','becomeasitter','becomeanowner','view-user-details','activitylog','updateactivity','newdashboardlist','addavailability','switch-account','switch-account1','newimagelist','removeservice','removepet','testview','bookingreminders','becomeaborrower','updatesubscription','bookingprice'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
