...
//[['pet_parent_type'], 'validateOwnerPet'],
            [['firstname', 'lastname', 'email', 'password', 'dob','user_type', 'zip_code'], 'required'],
            [['user_signin_type','interested_in_renting'],'safe'],
...
public function validateAddressbyZip() {
	...
	*/
    public function savedata() {
        ...
        if($this->interested_in_renting == 0){
		...
		try {
			...
			$user->renting_pet		= (isset($this->interested_in_renting)?$this->interested_in_renting : 0);
			$user->profile_completed_owner = $profilecompletestatus;
